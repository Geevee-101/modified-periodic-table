...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="./views/periodic-table/main.css">
		<style>
			a {
				color: #8ff;
			}
			...
			*/
			...
			function init() {
				...
				for ( let i = 0; i < table.length; i += 8 ) {
					...
					if (table[ i + 7 ] < 100000) {
						element.style.backgroundColor = '#EF302250';
						element.style.boxShadow = "0px 0px 12px #EF3022";
					} else if (table[ i + 7 ] > 200000) {
						element.style.backgroundColor = '#3A9F4850';
						element.style.boxShadow = "0px 0px 12px #3A9F48";
					} else {
						element.style.backgroundColor = '#FDCA3550';
